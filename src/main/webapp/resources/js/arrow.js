...
window.Arrow = (function (window, document, undefined) {
    ...
    function _applyStyleModern(node) {
        ...
        node.style.backgroundImage = 'url(../resources/images/arrowDown.png)';
    ...
    function _applyStyleIE8(node) {
        ...
        var opacity = 'progid:DXImageTransform.Microsoft.Alpha(opacity=0) ',
            imgSrc = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="../resources/images/arrowDown.png", sizingMethod="scale") ',
